...
class UpdatePlayerRequest extends FormRequest
{
    ...
    {
        return (bool) $this->user()?->can('update', $this->route('player'));
    }

    public function rules(): array
    {
        // Sport stays locked to whatever the player/team already has -
        // moving sports means moving teams, which is out of scope here.
        $sport = $this->route('player')?->sport ?? Player::SPORT_FOOTBALL;
