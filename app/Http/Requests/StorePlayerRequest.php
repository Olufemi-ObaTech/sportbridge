...
class StorePlayerRequest extends FormRequest
{
    ...
    {
        // Sport is inherited from the team, not chosen on this form - a
        // player can't belong to a team of a different sport.
        $sport = $this->route('team')?->sport ?? Player::SPORT_FOOTBALL;
